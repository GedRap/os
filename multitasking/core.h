...
struct os_task_ {
	...
	unsigned int stack_bottom; //bottom of the stack, initial SP value
	unsigned int sp; //current SP for the task
...
#define LOAD_OS_CONTEXT() \
asm volatile(      \
"lds r26, os_context \n" \
"lds r27, os_context + 1 \n" \
"ld r28, X+ \n" \
"out __SP_L__, r28 \n" \
"ld r29, X+ \n" \
"out __SP_H__, r29 \n" \
